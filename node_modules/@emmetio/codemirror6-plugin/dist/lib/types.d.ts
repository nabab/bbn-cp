...
export declare type EmmetKnownSyntax = 'html' | 'xml' | 'xsl' | 'jsx' | 'tsx' | 'vue' | 'haml' | 'jade' | 'pug' | 'slim' | 'css' | 'scss' | 'less' | 'sass' | 'sss' | 'stylus' | 'postcss';
export declare type CSSTokenType = 'selector' | 'propertyName' | 'propertyValue';
...
export declare type HTMLType = 'open' | 'close' | 'selfClose';
