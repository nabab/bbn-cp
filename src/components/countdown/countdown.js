...
const cpDef = {
  ...
  computed: {
    /**
     * The index of the 'precision' property in the array of the constant bbnCountdown.VALUES.
     * @return {Number} [5] precisionIdx
     */
    precisionIdx(){
      return bbn.fn.search(bbnCountdown.VALUES, this.precision.length === 1 ? 'code' : 'name', this.precision);
    },
    /**
     * The index of the 'scale' property in the array of the constant bbnCountdown.VALUES.
     * @return {Number} [5] scaleIdx
     */
    scaleIdx(){
      return bbn.fn.search(bbnCountdown.VALUES, this.scale.length === 1 ? 'code' : 'name', this.scale);
    },
    /**
