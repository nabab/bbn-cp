...
const cpDef = {
  ...
  data(){
    ...
    if (this.pref && (this.value.indexOf(this.pref) === 0)) {
...
import cpHtml from './password.html';
import cpStyle from './password.less';
let cpLang = {};
if (bbn.env.lang) {
  try {
    const lang = bbn.env.lang || 'en';
    cpLang = await import(`./_i18n/password.${lang}.lang`);
    if (cpLang.default) {
