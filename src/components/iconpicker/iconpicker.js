...
const cpDef = {
    ...
    data(){
      ...
      return {
        ...
        ready: true,
        sectionSize: 125,
        numIcons: bbnIconpicker.icons.length,
        ...
        numberShown: 10,
        timeout: false,
        total: bbnIconpicker.icons.length,
      };
    },
    computed: {
      // The array from which the source (currentIcons)is built
      icons() {
        const icons = this.searchFix ? bbnIconpicker.icons.filter(icon => icon.search(this.searchFix.toLowerCase()) > -1) : bbnIconpicker.icons;
        this.numIcons = icons.length;
        if (this.filter) {
          return icons.filter(this.filter).slice(0, this.numberShown);
        }
    ...
    methods:
    {
      ...
      init() {
        ...
        if (scroll) {
          this.currentWidth = scroll.clientWidth;
          this.scrollSize = scroll.clientHeight;
          this.containerSize = this.clientHeight;
        }
